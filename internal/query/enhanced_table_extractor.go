...
// EnhancedTableExtractor 增强的表名提取器
// 支持更复杂的SQL语法和查询类型识别
type EnhancedTableExtractor struct {
	// 缓存编译后的正则表达式以提高性能
...
// NewEnhancedTableExtractor 创建增强的表名提取器
func NewEnhancedTableExtractor() *EnhancedTableExtractor {
	return &EnhancedTableExtractor{
		// FROM子句匹配（支持别名、模式名）
...
func (e *EnhancedTableExtractor) ExtractTableNames(sql string) []string {
	// 清理SQL，去除注释和多余空格
...
// cleanSQL 清理SQL语句
func (e *EnhancedTableExtractor) cleanSQL(sql string) string {
	// 移除单行注释
...
func (e *EnhancedTableExtractor) extractFromTables(sql string) []string {
...
func (e *EnhancedTableExtractor) extractJoinTables(sql string) []string {
...
func (e *EnhancedTableExtractor) extractUpdateTables(sql string) []string {
...
func (e *EnhancedTableExtractor) extractInsertTables(sql string) []string {
...
func (e *EnhancedTableExtractor) extractDeleteTables(sql string) []string {
...
func (e *EnhancedTableExtractor) extractSubqueryTables(sql string) []string {
...
func (e *EnhancedTableExtractor) isValidTableName(tableName string) bool {
	// 检查是否为SQL关键字
...
func (e *EnhancedTableExtractor) uniqueStrings(input []string) []string {
...
func (e *EnhancedTableExtractor) ValidateTableNames(tables []string) []string {
...
// GetQueryType 获取查询类型
func (e *EnhancedTableExtractor) GetQueryType(sql string) string {
...
func (e *EnhancedTableExtractor) GetQueryComplexity(sql string) string {
...
func (e *EnhancedTableExtractor) ShouldCacheQuery(sql string) bool {
